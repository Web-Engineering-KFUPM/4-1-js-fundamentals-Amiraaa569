...
// the error appeared because the variable school was declared as a constant and constants cannot be reassigned
//console.log(SCHOOL);
...
console.log (2 + "3");
console.log (2 + 3);
// the first to concatenate because the number 2 in the first and 3 in the second are strings which cannot be added mathematically the integers
...
//console.log(b);
//console.log(c);
// a is accessible outside, b and c are not and this is why i commented them because they show errors.
